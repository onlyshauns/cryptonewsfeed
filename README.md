...
- **Market Analysis**: Click "AI Summary" to get instant market analysis showing sentiment, top cryptocurrencies, trending topics, and key themes (powered by keyword analysis - no API required)
...
- **Analysis**: Keyword-based sentiment and trend analysis (no external AI API required)
- **APIs**:
