  ...
  return (
    <div className="rounded-xl p-6 bg-white/[0.02] border border-white/10">
        ...
        {visibleArticles.map((article) => {
          ...
          return (
            <a
              ...
              className="flex gap-4 p-4 rounded-lg hover:bg-white/[0.02] transition-colors cursor-pointer"
            >
              {article.thumbnail && (
      ...
      {hasMore && (
        <button
          onClick={loadMore}
          className="mt-6 w-full px-6 py-3 bg-white/5 hover:bg-white/10 rounded-lg text-white font-medium transition-colors border border-white/10"
        >
